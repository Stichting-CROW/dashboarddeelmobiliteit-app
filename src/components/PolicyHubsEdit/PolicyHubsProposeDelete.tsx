  ...
  return (
    <div>
      <div className={`mb-2 font-bold`}>
        Voorstel tot verwijderen van zone
      </div>
            ...
            <Tooltip open={tooltipOpen.publish} onOpenChange={(open) => setTooltipOpen({ ...tooltipOpen, publish: open })}>
              ...
              >
                <p className="text-sm leading-tight font-normal text-white">
                  ...
                  <br />
                  Vanaf deze datum is de verwijdering van deze zone gepubliceerd. Aanbieders kunnen deze gaan verwerken in hun servicegebied.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
            ...
            <Tooltip open={tooltipOpen.effective} onOpenChange={(open) => setTooltipOpen({ ...tooltipOpen, effective: open })}>
              ...
              >
                <p className="text-sm leading-tightt font-normal text-white">
                  ...
                  <br />
                  Vanaf deze datum is deze verwijdering 'Definitief actief' en moet de aanbieder deze verwerkt hebben in het servicegebied.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
...
export default PolicyHubsProposeDelete;
